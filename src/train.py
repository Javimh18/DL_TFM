...
if __name__ == '__main__':
    ...
    parser.add_argument("-sv", "--save_video_progress", help="Boolean flag that specifies if videos throughout the training process are saved", default=False, action="store_true")
